...
export default function LibraryScreen(): JSX.Element {
	...
	return (
		<View style={[styles.container, { backgroundColor: selectThemeColor(mode, 'background') }]}>
			<Text style={[styles.title, { color: theme.color.text[mode] }]}>Library</Text>
			<Text style={[styles.body, { color: theme.color.subtleText[mode] }]}>Saved items will live here soon.</Text>
		</View>
	)
}
