...
import { StyleSheet, Pressable, Modal, TouchableOpacity, View, ActivityIndicator, ScrollView } from 'react-native'
...
type MultiSelectFilterProps<T extends Option> = {
	label: string
	queryKey: string
...
export function MultiSelectFilter<T extends Option>({
	label,
	queryKey,
	fetchFn,
	selectedIds,
	onChange,
}: MultiSelectFilterProps<T>): React.JSX.Element {
