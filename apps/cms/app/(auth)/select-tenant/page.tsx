...
async function SelectTenantPage() {
	...
	if (tenants.length === 0) {
		return (
			<div className="text-center">
				<h1 className="mb-2 text-2xl font-bold">No Tenants Available</h1>
				<p className="text-gray-600">
					There are no tenants available for registration. Please contact an administrator.
				</p>
			</div>
		)
	}

	return <TenantSelection tenants={tenants} userEmail={pendingUserData.email} />
}
